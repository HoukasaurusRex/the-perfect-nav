# Contributing to the-perfect-nav

First and foremost, thank you! We appreciate that you want to contribute to the-perfect-nav, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for the-perfect-nav**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for the-perfect-nav:

- star the [project]()
- tweet your support for the-perfect-nav
...
- **version**: (required) please note the version of the-perfect-nav are you using
...
The original poster or the maintainers of the-perfect-nav may close an issue at any time. Typically, but not exclusively, issues are closed when:
...
[so]: http://stackoverflow.com/questions/tagged/the-perfect-nav
